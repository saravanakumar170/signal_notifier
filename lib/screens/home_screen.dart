...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _sendSignal(String signalType) async {
    final success = await _signalManager.sendSignal(signalType);
    ...
    if (success) {
      ...
      } else if (_storage.lastSignalType == signalType) {
